...
Estas Condiciones regulan el uso de la aplicación OmniTutor para iOS (la "App"), titularidad de:
...
Al crear una cuenta o usar la App aceptas estas Condiciones y la [Política de Privacidad](/omnitutor-legal/privacidad/). Si no estás de acuerdo, no uses la App. Debes tener al menos **14 años** para usar OmniTutor.
...
Te concedemos una licencia personal, limitada, no exclusiva, intransferible y revocable para instalar y usar la App en dispositivos Apple de tu propiedad o control, conforme a estas Condiciones y a las Normas de Uso del App Store. No adquieres la propiedad de la App. No puedes copiar, modificar, distribuir, vender, ceder, realizar ingeniería inversa ni extraer el código fuente de la App, salvo en la medida en que la ley lo permita expresamente.
...
El software, el diseño, las marcas y los contenidos propios de OmniTutor nos pertenecen o están licenciados a nuestro favor. Nada en estas Condiciones te transfiere derechos sobre ellos, ni afecta a la titularidad de tus propios documentos (apartado 6).

## 11. Disponibilidad y cambios del servicio

Prestamos el servicio con diligencia profesional, pero no garantizamos disponibilidad ininterrumpida (mantenimientos, incidencias de terceros, causas de fuerza mayor). Podemos evolucionar la App (añadir, modificar o retirar funciones). Si un cambio reduce sustancialmente funciones esenciales para ti como consumidor, podrás resolver el contrato conforme a la normativa de consumo aplicable.

## 12. Garantías y responsabilidad

- Respondemos conforme a la legislación española de consumo de la falta de conformidad del servicio digital. **Nada en estas Condiciones limita los derechos que la ley reconoce imperativamente a los consumidores**, ni nuestra responsabilidad por dolo, culpa grave, o daños personales.
- Con ese límite, no seremos responsables de: (a) decisiones que tomes basándote en contenido generado por IA sin verificarlo (apartado 7); (b) pérdida de datos almacenados únicamente en tu dispositivo si lo pierdes, restauras o desinstalas la App sin copia de seguridad propia; (c) daños indirectos o lucro cesante; (d) fallos imputables a servicios de terceros fuera de nuestro control.
- Recuerda que los datos locales (documentos, chats, cuestionarios) residen solo en tu dispositivo: te recomendamos mantener tus documentos originales a salvo fuera de la App.

## 13. Protección de datos

El tratamiento de tus datos personales se rige por nuestra [Política de Privacidad](/omnitutor-legal/privacidad/), que forma parte integrante de estas Condiciones.

## 14. Condiciones relativas a Apple
...
- **Apple y sus filiales son terceros beneficiarios** de estas Condiciones y, al aceptarlas, Apple tendrá derecho (y se entenderá que ha aceptado el derecho) a hacerlas valer frente a ti como tercero beneficiario.
- Debes cumplir además las condiciones de terceros aplicables al usar la App (por ejemplo, las de tu operador de datos).

## 15. Cambios en estas Condiciones

Podemos actualizar estas Condiciones. Si el cambio es sustancial, te lo comunicaremos dentro de la App y te pediremos aceptarlas de nuevo antes de continuar usándola. La fecha de la última versión figura en el encabezado.

## 16. Ley aplicable y jurisdicción

Estas Condiciones se rigen por la **legislación española**. Si actúas como consumidor, cualquier controversia se someterá a los juzgados y tribunales de tu domicilio en España, y conservas además el derecho a acudir a los servicios públicos de consumo y a las entidades acreditadas de resolución alternativa de litigios de consumo.
